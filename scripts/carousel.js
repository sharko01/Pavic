...
export default function description(produit){

    const imageCarousel = produit.imageCarousel;
    ...
    imageCarousel.forEach((url, key) =>{
        ...
        if (key===0){
            ...
            boutonIndicator.classList.add("active");
            boutonIndicator.setAttribute("aria-current", "true")
        }
        imgCarousel.src = url;
